...
\captionsetup{ labelsep=space,% 去掉图标签后的冒号 % 原模板labelsep=twospace，而论文撰写规范要求是space
  ...
  font={capFont}, figurename=图,tablename=表,listfigurename=图目录,listtablename=表目录}
...
\title{\vspace{-1.5cm} \bf\xiaoerhao LLMorpheus: 基于大语言模型的变异测试\\课程报告}
...
\fancyhead{}
\fancyhead[C]{\wuhao{LLMorpheus: 基于大语言模型的变异测试}}
