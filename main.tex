...
\setCJKsansfont{Songti SC}	%设置默认字体，防止报警
\setCJKmonofont{Songti SC} %设置默认字体，防止报警
...
\title{\vspace{-1.5cm} \bf\xiaoerhao Review Report on ``Learning Soft Sparse Shapes for Efficient\\Time-Series Classification''}
\author{\bf\sihao Yuhong Xu}
\date{}
...
\fancyhead{}
\fancyhead[C]{\wuhao{Review Report on SoftShape}}
